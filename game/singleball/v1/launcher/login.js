...
//var signUrl = "/BonusLottery/sign.json?type=login&url=" + encodeURIComponent(indexUrl);
var signUrl = "/BonusLottery/engin/sign.json?type=login&activityCode=" + encodeURIComponent(activityCode);
var requestUrl = window["debugRequestUrl"];
